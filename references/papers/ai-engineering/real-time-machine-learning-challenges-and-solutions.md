...
description: \[Twitter discussion, LinkedIn\]
author: Chip Huyen
...
## Towards Online Prediction {#towards-online-prediction}
...
### Stage 1. Batch prediction {#batch-prediction}
...
### Stage 2. Online prediction with batch features {#session-based-prediction}
...
### Stage 3. Online prediction with online features {#online-prediction}
...
#### Near RT features {#near-rt-features}
...
## Discussion: Online prediction for bandits and contextual bandits {#bandits}
...
### Bandits for model evaluation {#model-bandits}
...
### Contextual bandits as an exploration strategy {#contextual-bandits}
...
### Stage 1. Manual, Stateless Retraining {#manual-stateless-retraining}
...
### Stage 2. Automated Retraining {#automated-retraining}
...
### Bonus: Log and wait (feature reuse) {#bonus-log-and-wait-feature-reuse}
...
### Stage 3. Automated, Stateful Training {#stateful-training}
...
### Stage 4. Continual Learning {#continual-learning}
...
### On the efficiency of stream processing vs. batch processing {#stream-batch-processing}
...
### What do feature stores do? {#what-do-feature-stores-do}
