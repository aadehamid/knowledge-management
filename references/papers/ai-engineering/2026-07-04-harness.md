...
author: Lilian Weng
keywords: language-model, agent, auto-research, self-improvement, prompting
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/openai-agent-loop.png "A simplified Codex agent loop: the agent calls tools and tool responses affect the model's next generation.(Image source: OpenAI codex agent post)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/ace.png "The framework of Agentic Context Engineering (ACE). (Image source: Zhang et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/mce.png "The framework of Meta Context Engineering (MCE): meta-level skill evolution searches over context-management mechanisms, while the base level optimizes the task context. (Image source: Ye et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/meta-harness-outer-loop.png "The Meta-Harness outer-loop optimization algorithm. (Image source: Lee et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/ai-scientist.png "AI Scientist pipeline for idea generation, experimentation, paper writing, and review. (Image source: Lu et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/autodata.png "Autodata agentic workflow design for generating synthetic training and evaluation data around challenger, solver, and verifier roles. (Image source: Kulikov et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/adas.png "Illustration of Automated Design of Agentic Systems (ADAS).(Image source: Hu et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/aflow.png "AFlow optimization process over a tree of workflow candidates. (Image source: Zhang et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/aflow-exp.png "AFlow experiments in comparison to manual methods and ADAS. (Image source: Zhang et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/STOP-algo.png "Algorithm of Self-Taught Optimizer (STOP). (Image source: Zelikman et al. 2023)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/STOP-patterns.png "Examples of self-improvement strategies discovered by STOP. (Image source: Zelikman et al. 2023)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/harness-update.png "Main results: (A) harness updating capability is measured flat across a range of models from Qwen2-32B to Opus 4.6; (B) harness benefit capability is non-monotonic where middle tier models benefit the most. (Image source: Lin et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/self-harness.png "Self-Harness uses a loop of weakness mining, bounded harness proposal, and validation to update a harness. (Image source: Zhang et al. 2026)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/alphaevolve.png "How AlphaEvolve works. (Image source: Novikov et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/alphaevolve-plot.png "Ablations show the value of everal designs in AlphaEvolve. (Image source: Novikov et al. 2025)")
...
![](https://lilianweng.github.io/posts/2026-07-04-harness/SIA.png "The Feedback-Agent in SIA decides the next iteration type. (Image source: Hebbar et al. 2026)")
