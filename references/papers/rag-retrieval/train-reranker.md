...
[![Model size vs NDCG for Rerankers on GooAQ](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-reranker/reranker_gooaq_model_size_ndcg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-reranker/reranker_gooaq_model_size_ndcg.png)
...
> Which of these $kk$ highly-related documents answers the query the best?
...
Additionally, if your dataset has extraneous columns (e.g. sample\_id, metadata, source, type), you should remove these with [`Dataset.remove_columns`](https://huggingface.co/docs/datasets/main/en/package_reference/main_classes#datasets.Dataset.remove_columns) as they will be used as inputs otherwise. You can also use [`Dataset.select_columns`](https://huggingface.co/docs/datasets/main/en/package_reference/main_classes#datasets.Dataset.select_columns) to keep only the desired columns.
...
> [!NOTE]- Click to see the outputs of this script.
> ```
> Dataset({
...
> [!NOTE]- Click to see the Evaluation Script & datasets
