...
[sparse-encoder/example-inference-free-splade-distilbert-base-uncased-nq](https://huggingface.co/sparse-encoder/example-inference-free-splade-distilbert-base-uncased-nq)
...
After running a slightly modified version of our [hybrid\_search.py](https://github.com/UKPLab/sentence-transformers/blob/master/examples/sparse_encoder/applications/retrieve_rerank/hybrid_search.py) script, we get the following results for the NanoMSMARCO dataset, using these models:
