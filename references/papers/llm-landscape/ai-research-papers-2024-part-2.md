...
description: Six influential AI papers from July to December
...
![](https://substackcdn.com/image/fetch/$s_!T2DE!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F88588e3b-8d4e-403d-a9a3-75ca22546dd8_1600x832.png "Comparison of the training set sizes of various models."){width=681 height=354.0638736263736}
...
![](https://substackcdn.com/image/fetch/$s_!nfh6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2500d56c-9565-4134-8f20-2e9590c43025_1354x682.png "Summary of techniques used in pre-training Llama 3.1."){width=1354 height=682}
...
![](https://substackcdn.com/image/fetch/$s_!ORr_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1af88b42-330d-4505-a21b-2af5da777a65_1374x668.png "Summary of techniques used in pre-training Llama 3.1."){width=1374 height=668}
...
![](https://substackcdn.com/image/fetch/$s_!AO8D!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0537fd6d-81d4-4b6a-b0ee-0eb6f83caed3_1600x919.png "Different search-based methods rely on a process-reward-based model to select the best answer. Annotated figure from the LLM Test-Time Compute paper, https://arxiv.org/abs/2408.03314"){width=1456 height=836}
...
![](https://substackcdn.com/image/fetch/$s_!jXH1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff445a8b5-7b5f-49a4-bfce-20c19b77898d_1600x951.png "An illustration of a multimodal LLM that can accept different input modalities (audio, text, images, and videos) and returns text as the output modality."){width=579 height=343.9800824175824}
...
![](https://substackcdn.com/image/fetch/$s_!rOIy!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4ebc87a3-5694-4968-a56d-a9fc0cae52bd_1600x941.png "The two main approaches to developing multimodal LLM architectures."){width=1456 height=856}
...
![](https://substackcdn.com/image/fetch/$s_!3QeO!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5ef4b49a-bb6b-4c40-9786-e99fc319b405_1600x930.png "Overview of the three multimodal approaches. (Annotated figure from the NVLM: Open Frontier-Class Multimodal LLMs paper: https://arxiv.org/abs/2409.11402)"){width=1456 height=846}
...
![](https://substackcdn.com/image/fetch/$s_!3yqP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe76d574c-b3b9-4a69-ba8c-9e8ba5c9f658_1436x1078.png "Traditionally, LLMs are trained on the correct solution path (shortcut learning); in journey learning, the supervised finetuning encompasses the whole trial-and-error correction process. Annotated figure from the O1 Replication Report, https://arxiv.org/abs/2410.18982"){width=524 height=393.3649025069638}
...
![](https://substackcdn.com/image/fetch/$s_!iztP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0fc97155-9781-4854-ad3a-318b5cb513a3_1490x1152.png "LLMs trained with shortcut and journey learning. Annotated figure from the O1 Replication Report, https://arxiv.org/abs/2410.18982"){width=545 height=421.47664835164835}
...
![](https://substackcdn.com/image/fetch/$s_!X24t!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff878e905-f725-45e5-a79e-e2360aff7f64_1496x712.png){width=1456 height=693}
...
![](https://substackcdn.com/image/fetch/$s_!grNH!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0240c9f4-42c6-48f5-ae19-dff4cab66d5d_1498x848.png){width=1456 height=824}
...
![](https://substackcdn.com/image/fetch/$s_!g3Z5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F18b90caf-2e5c-4881-9614-1d2e8bc38d7a_1470x752.png "Comparison between 32-bit and 16-bit floating point precision"){width=1456 height=745}
...
![](https://substackcdn.com/image/fetch/$s_!j8VB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd49ae533-2056-4b47-9902-fb91bf7fe757_1526x784.png "Comparison between regular 16-bit floating point and the popular 16-bit brain floating point precision"){width=1456 height=748}
...
![](https://substackcdn.com/image/fetch/$s_!I8pP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe72da1a4-61fa-4405-8f04-0d95903d0dec_1208x848.png "The effect of more training data on the validation loss for various post-quantization formats"){width=651 height=456.9933774834437}
...
![](https://substackcdn.com/image/fetch/$s_!CJnC!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F86f231ce-50df-4052-8b97-7f9c13dbc154_1600x1142.png "Performance of phi-4 compared to other models of similar and different sizes (annotated table from the phi-4 paper, https://arxiv.org/abs/2412.08905)"){width=1456 height=1039}
...
![](https://substackcdn.com/image/fetch/$s_!sqLf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F467b5f2d-088c-48c6-b33d-54dead7a7b28_1434x594.png "Dataset mix for training phi-4 (annotated table from the phi-4 paper, https://arxiv.org/abs/2412.08905)."){width=1434 height=594}
...
![](https://substackcdn.com/image/fetch/$s_!3bRk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F55e20e2b-a020-48cf-94e9-1d097483d5e0_1600x654.png "Model performance comparison for different synthetic/web dataset ratios. (Annotated figure from the phi-4 paper, https://arxiv.org/abs/2412.08905)."){width=1456 height=595}
...
![](https://substackcdn.com/image/fetch/$s_!npRQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb640d0f0-5ec4-442d-a766-6c2e9477122f_1600x676.png "Back-off-the-envelope calculation from the DeepSeek-v3 report, https://github.com/deepseek-ai/DeepSeek-V3/blob/main/DeepSeek_V3.pdf"){width=1456 height=615}
