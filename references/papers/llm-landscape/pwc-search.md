...
[revival](https://www.reddit.com/r/MachineLearning/comments/1tgmwqr/reviving_paperswithcode_by_hugging_face_p/)

[Papers with Code](https://paperswithcode.co)

[announcement tweet](https://x.com/NielsRogge/status/2056366395605078252)
...
![Papers with Code search results for the query 'DINO'](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/pwc-search/search-results.png "Search results on Papers with Code for the query DINO."){width=600}
...
![Chart showing hybrid retrieval outperforming vector-only and keyword search](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/pwc-search/hybrid-search.png "Hybrid retrieval outperforms keyword- and vector-only search. Figure from Microsoft, Azure AI Search: Outperforming vector search with hybrid retrieval and reranking (2023)."){width=600}
...
![Architecture diagram of the offline corpus build and online hybrid search pipeline](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/pwc-search/architecture.png "Architecture of the offline corpus build and online hybrid search pipeline."){width=600}
...
![Hugging Face Inference Endpoint overview for the Papers with Code query embedding model](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/pwc-search/inference-endpoint.png "Hugging Face Inference Endpoint for the Papers with Code query embedding model."){width=800}
...
$$\text{score}(d)=\underset{r\text{}\in\text{}\{\text{lexical},\text{}\text{semantic}\}}{\sum}\frac{w_{r}}{k+\text{rank}_{r}(d)}
...
![Related papers feature](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/pwc-search/related_papers.png "Related papers for SenseNova-U1."){width=400}
