title: GitHub - google-research/tabfm: TabFM \(Tabular Foundation Model\) is a pretrained tabular foundation model developed by Google Research for tabular data regression and classification.
description: TabFM \(Tabular Foundation Model\) is a pretrained tabular foundation model developed by Google Research for tabular data regression and classification. - google-research/tabfm

# GitHub - google-research/tabfm: TabFM (Tabular Foundation Model) is a pretrained tabular foundation model developed by Google Research for tabular data regression and classification.
...
For a complete list of pinned dependencies and versions, please see [requirements.txt](https://github.com/google-research/tabfm/blob/main/requirements.txt). The core requirements depend on the backend you choose:
...
You can find runnable scripts for both classification and regression under the [examples/](https://github.com/google-research/tabfm/blob/main/examples) folder:

- [classification\_example.py](https://github.com/google-research/tabfm/blob/main/examples/classification_example.py)
- [regression\_example.py](https://github.com/google-research/tabfm/blob/main/examples/regression_example.py)
...
Our model evaluation results can be found in [results/](https://github.com/google-research/tabfm/blob/main/results).
