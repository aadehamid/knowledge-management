...
[Llama collection](https://huggingface.co/collections/meta-llama/llama-32-66f448ffc8c32f949b04c8cf)
...
[![License Change](https://huggingface.co/datasets/huggingface/release-assets/resolve/main/license_change.png)](https://huggingface.co/datasets/huggingface/release-assets/resolve/main/license_change.png)
...
[![Demo GIF](https://huggingface.co/datasets/huggingface/release-assets/resolve/main/demo_gif.gif)](https://huggingface.co/datasets/huggingface/release-assets/resolve/main/demo_gif.gif)
...
- By default, transformers uses the same sampling parameters (temperature\=0.6 and top\_p\=0.9) as the original meta codebase. We haven’t conducted extensive tests yet, feel free to explore!
