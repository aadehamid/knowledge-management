...
![Carpentries Incubator](assets/images/incubator-logo.svg)
...
[Instructor View](instructor/global_local_memory.html)

## EPISODES

[Summary and Setup](index.html)

[1. Introduction](introduction.html)

[2. Using your GPU with CuPy](cupy.html)

[3. Using PyTorch for GPU Computing](pytorch.html)

[4. Accelerate your Python code with Numba](numba.html)

[5. A Better Look at the GPU](gpu_introduction.html)

[6. Your First GPU Kernel](first_program.html)

Current Chapter

7. Registers, Global, and Local Memory

[8. Shared Memory and Synchronization](shared_memory_and_synchronization.html)

[9. Constant Memory](constant_memory.html)

[10. Concurrent access to the GPU](streams.html)
...
[Previous](first_program.html)
[Next](shared_memory_and_synchronization.html)

[Previous: Your First GPU](first_program.html)
[Next: Shared Memory and...](shared_memory_and_synchronization.html)

# Registers, Global, and Local Memory

Last updated on 2026-06-02 |
[Edit this page](https://github.com/carpentries-incubator/lesson-gpu-programming/edit/main/episodes/global_local_memory.Rmd)
...
* “What are the differences between the memory spaces available in
  CUDA?”
* “What happens when a thread uses more variables than there are
  available registers?”

### Objectives

* “Describe the scope, lifetime, and performance characteristics of
  registers, global memory, and local memory”
* “Identify which memory type is used for a given variable in a CUDA
  kernel”
* “Explain when the compiler automatically uses local memory instead
  of registers”
...
This is totally unnecessary in the case of our example, because the
...
The host code could be modified by adding one line and changing the
way the kernel is called.
...
Local memory is not a particularly fast memory, and in fact it has
similar throughput and latency of global memory, but it is much larger
than registers. As an example, local memory is automatically used by the
CUDA compiler to store spilled registers, i.e. to temporarily store
variables that cannot be kept in registers anymore because there is not
enough space in the register file, but that will be used again in the
future and so cannot be erased.
...
[Edit on GitHub](https://github.com/carpentries-incubator/lesson-gpu-programming/edit/main/episodes/global_local_memory.Rmd)
| [Contributing](https://github.com/carpentries-incubator/lesson-gpu-programming/blob/main/CONTRIBUTING.md)
| [Source](https://github.com/carpentries-incubator/lesson-gpu-programming/)

[Cite](https://github.com/carpentries-incubator/lesson-gpu-programming/blob/main/)
| Contact | [About](https://carpentries.org/about/)
...
Built with [sandpaper (0.20.2)](https://github.com/carpentries/sandpaper/tree/), [pegboard (0.7.9)](https://github.com/carpentries/pegboard/tree/), and [varnish (1.1.1)](https://github.com/carpentries/varnish/tree/)
