...
ProfileStep#2
 ...
 is visibly wider than the steps that follow it
...
Figure 6: The \~228 µs dead window between 

record\_function("matmul\_add")
...
Figure 20: Compiled run dispatches a single 
