title: GitHub - gordicaleksa/pytorch-original-transformer: My implementation of the original transformer model \(Vaswani et al.\). I've additionally included the playground.py file for visualizing otherwise seemingly hard concepts. Currently included IWSLT pretrained models.
description: My implementation of the original transformer model \(Vaswani et al.\). I've additionally included the playground.py file for visualizing otherwise seemingly hard concepts. Currently included IWSLT pretrained models. - gordicaleksa/pytorch-original-transformer
...
This repo contains PyTorch implementation of the original transformer paper (:link: [Vaswani et al.](https://arxiv.org/abs/1706.03762)). \
...
Here is how their beautifully simple architecture looks like:
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/transformer_architecture.PNG){width=350}](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/transformer_architecture.PNG) 
...
Can you parse this one in a glimpse of the eye?
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/positional_encoding_formula.PNG)](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/positional_encoding_formula.PNG) 

Neither can I. Running the `visualize_positional_encodings()` function from `playground.py` we get this:

 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/positional_encoding_visualized.jpg)](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/positional_encoding_visualized.jpg) 
...
Similarly can you parse this one in `O(1)`?
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/lr_formula.PNG)](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/lr_formula.PNG) 

Noup? So I thought, here it is visualized:

 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/custom_learning_rate_schedule.PNG)](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/custom_learning_rate_schedule.PNG) 

It's super easy to understand now. Now whether this part was crucial for the success of transformer? I doubt it. But it's cool and makes things more complicated. 🤓 (`.set_sarcasm(True)`)
...
First time you hear of label smoothing it sounds tough but it's not. You usually set your target vocabulary distribution to a `one-hot`. Meaning 1 position out of 30k (or whatever your vocab size is) is set to 1. probability and everything else to 0.
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/label_smoothing.PNG){width=700}](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/label_smoothing.PNG) 
...
What I did (for now) is I trained my models on the [IWSLT dataset](https://torchtext.readthedocs.io/en/latest/datasets.html#iwslt), which is much smaller, for the English-German language pair, as I speak those languages so it's easier to debug and play around.
...
**Important note:** Initialization matters a lot for the transformer! I initially thought that other implementations using Xavier initialization is again one of those arbitrary heuristics and that PyTorch default init will do - I was wrong:
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/bleu_score_xavier_vs_default_pt_init.PNG){width=450}](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/bleu_score_xavier_vs_default_pt_init.PNG) 
...
These belong to layer 6 of the encoder. You can see all of the 8 multi-head attention heads.
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/attention_enc_self.PNG){width=850}](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/attention_enc_self.PNG) 
...
And this one belongs to decoder layer 6 of the self-attention decoder MHA (multi-head attention) module. \
 ...
 [![](https://github.com/gordicaleksa/pytorch-original-transformer/raw/main/data/readme_pics/attention_dec_self.PNG){width=850}](https://github.com/gordicaleksa/pytorch-original-transformer/blob/main/data/readme_pics/attention_dec_self.PNG) 
...
If you're having difficulties understanding the code I did an in-depth overview of the paper [in this video:](https://www.youtube.com/watch?v=cbYxHkgkSVs)
 ...
 [![A deep dive into the attention is all you need paper](https://camo.githubusercontent.com/121d8e22ebf2bc16aaa34068108075bfc0e85e5f683affc9dec3575efec59700/68747470733a2f2f696d672e796f75747562652e636f6d2f76692f63625978486b676b5356732f302e6a7067){width=480 height=360}](https://www.youtube.com/watch?v=cbYxHkgkSVs) 
...
- Follow me on [LinkedIn](https://www.linkedin.com/in/aleksagordic/) and 💡
- Follow me on [Medium](https://gordicaleksa.medium.com/) 📚 ❤️

[![License: MIT](https://camo.githubusercontent.com/fdf2982b9f5d7489dcf44570e714e3a15fce6253e0cc6b5aa61a075aac2ff71b/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d4d49542d79656c6c6f772e737667)](https://github.com/gordicaleksa/pytorch-original-transformer/blob/master/LICENCE)
