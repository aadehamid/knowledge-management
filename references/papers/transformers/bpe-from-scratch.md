...
description: Implements byte pair encoding \(BPE\) tokenization from scratch: tokenizer training, GPT-style merge rules, and step-by-step Python examples.
...
## 1. The main idea behind byte pair encoding (BPE)  {#1-the-main-idea-behind-byte-pair-encoding-bpe}
...
![Overview diagram illustrating byte pair encoding token merges](https://sebastianraschka.com/images/LLMs-from-scratch-images/bonus/bpe-from-scratch/bpe-overview.webp){width=600 height=432}

### 1.1 Bits and bytes  {#11-bits-and-bytes}
...
![Screenshot of the Tiktokenizer app showing GPT-2 tokenization results](https://sebastianraschka.com/images/LLMs-from-scratch-images/bonus/bpe-from-scratch/tiktokenizer.webp){width=600 height=333}
...
### 1.2 Building the vocabulary  {#12-building-the-vocabulary}
...
### 1.3 BPE algorithm outline  {#13-bpe-algorithm-outline}
...
- The size of the lookup table is a hyperparameter, also called “[vocabulary size](https://sebastianraschka.com/glossary/#vocabulary-size "Vocabulary Size")” (for GPT-2, that’s 50,257)
...
### 1.4 BPE algorithm example  {#14-bpe-algorithm-example}

#### 1.4.1 Concrete example of the encoding part (steps 1 & 2 in section 1.3)  {#141-concrete-example-of-the-encoding-part-steps-1--2-in-section-13}
...
#### 1.4.2 Concrete example of the decoding part (step 3 in section 1.3)  {#142-concrete-example-of-the-decoding-part-step-3-in-section-13}
...
### 2. A simple BPE implementation  {#2-a-simple-bpe-implementation}
...
### 3. BPE implementation walkthrough  {#3-bpe-implementation-walkthrough}
...
#### 3.1 Training, encoding, and decoding  {#31-training-encoding-and-decoding}
...
#### 3.2 Saving and loading the tokenizer  {#32-saving-and-loading-the-tokenizer}
...
#### 3.3 Loading the original GPT-2 BPE tokenizer from OpenAI  {#33-loading-the-original-gpt-2-bpe-tokenizer-from-openai}
