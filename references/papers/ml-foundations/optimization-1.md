...
#### Strategy #1: A first very bad idea solution: Random search {#strategy-1-a-first-very-bad-idea-solution-random-search}
...
#### Strategy #2: Random Local Search {#strategy-2-random-local-search}
...
#### Strategy #3: Following the Gradient {#strategy-3-following-the-gradient}
...
#### Computing the gradient numerically with finite differences {#computing-the-gradient-numerically-with-finite-differences}
...
#### Computing the gradient analytically with Calculus {#computing-the-gradient-analytically-with-calculus}
