...
### Base Case: Single Gate in the Circuit {#base-case-single-gate-in-the-circuit}
...
#### Strategy #1: Random Local Search {#strategy-1-random-local-search}
...
#### Stategy #2: Numerical Gradient {#stategy-2-numerical-gradient}
...
#### Strategy #3: Analytic Gradient {#strategy-3-analytic-gradient}
...
### Recursive Case: Circuits with Multiple Gates {#recursive-case-circuits-with-multiple-gates}
...
#### Patterns in the “backward” flow {#patterns-in-the-backward-flow}
...
### Example: Single Neuron {#example-single-neuron}
...
### Becoming a Backprop Ninja {#becoming-a-backprop-ninja}
...
#### Learning a Support Vector Machine {#learning-a-support-vector-machine}
...
#### Generalizing the SVM into a Neural Network {#generalizing-the-svm-into-a-neural-network}
...
### A more Conventional Approach: Loss Functions {#a-more-conventional-approach-loss-functions}
...
#### Example: 2-D Support Vector Machine {#example-2-d-support-vector-machine}
...
## Chapter 3: Backprop in Practice {#chapter-3-backprop-in-practice}

### Building up a library {#building-up-a-library}

### Example: Practical Neural Network Classifier {#example-practical-neural-network-classifier}
...
### Example: Structured Prediction {#example-structured-prediction}
...
### Backprop in practice: Tips/Tricks {#backprop-in-practice-tipstricks}
...
## Chapter 4: Networks in the Wild {#chapter-4-networks-in-the-wild}

Case studies of models that work well in practice and have been deployed in the wild.

### Case Study: Convolutional Neural Networks for images {#case-study-convolutional-neural-networks-for-images}

Convolutional layers, pooling, AlexNet, etc.

### Case Study: Recurrent Neural Networks for Speech and Text {#case-study-recurrent-neural-networks-for-speech-and-text}

Vanilla Recurrent nets, bi-directional recurrent nets. Maybe overview of LSTM

### Case Study: Word2Vec {#case-study-word2vec}

Training word vector representations in NLP

### Case Study: t-SNE {#case-study-t-sne}
