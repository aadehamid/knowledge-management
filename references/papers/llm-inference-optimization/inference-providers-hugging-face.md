title: Inference Providers · Hugging Face
description: We’re on a journey to advance and democratize artificial intelligence through open source and open science.

#  Inference Providers

![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/Inference-providers-banner-light.png)
...
[Baseten](https://huggingface.co/docs/inference-providers/en/providers/baseten)

[Cerebras](https://huggingface.co/docs/inference-providers/en/providers/cerebras)

[Cohere](https://huggingface.co/docs/inference-providers/en/providers/cohere)

[DeepInfra](https://huggingface.co/docs/inference-providers/en/providers/deepinfra)

[Fal AI](https://huggingface.co/docs/inference-providers/en/providers/fal-ai)

[Featherless AI](https://huggingface.co/docs/inference-providers/en/providers/featherless-ai)

[Fireworks](https://huggingface.co/docs/inference-providers/en/providers/fireworks-ai)

[Groq](https://huggingface.co/docs/inference-providers/en/providers/groq)

[HF Inference](https://huggingface.co/docs/inference-providers/en/providers/hf-inference)

[Novita](https://huggingface.co/docs/inference-providers/en/providers/novita)

[Nscale](https://huggingface.co/docs/inference-providers/en/providers/nscale)

[OVHcloud AI Endpoints](https://huggingface.co/docs/inference-providers/en/providers/ovhcloud)

[Public AI](https://huggingface.co/docs/inference-providers/en/providers/publicai)

[Replicate](https://huggingface.co/docs/inference-providers/en/providers/replicate)

[Scaleway](https://huggingface.co/docs/inference-providers/en/providers/scaleway)

[Together](https://huggingface.co/docs/inference-providers/en/providers/together)

[WaveSpeedAI](https://huggingface.co/docs/inference-providers/en/providers/wavespeed)

[Z.ai](https://huggingface.co/docs/inference-providers/en/providers/zai-org)
...
Prefer the terminal? Run `hf models ls --warm` with the [`hf` CLI](https://huggingface.co/docs/huggingface_hub/package_reference/cli#hf-models-list) to list every model served by at least one provider, and add `--json` for scripts and agents. See the [Hub API](https://huggingface.co/docs/inference-providers/en/hub-api) page for the full set of filters.
...
- **[Pricing and Billing](https://huggingface.co/docs/inference-providers/en/pricing)**: Understand costs and billing of Inference Providers
- **[Hub Integration](https://huggingface.co/docs/inference-providers/en/hub-integration)**: Learn how Inference Providers are integrated with the Hugging Face Hub
- **[Register as a Provider](https://huggingface.co/docs/inference-providers/en/register-as-a-provider)**: Requirements to join our partner network as a provider
- **[Hub API](https://huggingface.co/docs/inference-providers/en/hub-api)**: Advanced API features and configuration
- **[API Reference](https://huggingface.co/docs/inference-providers/en/tasks/index)**: Complete parameter documentation for all supported tasks
