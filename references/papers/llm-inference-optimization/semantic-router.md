title: GitHub - vllm-project/semantic-router: A programmable Mixture-of-Models router for heterogeneous LLM inference
description: A programmable Mixture-of-Models router for heterogeneous LLM inference - vllm-project/semantic-router

# GitHub - vllm-project/semantic-router: A programmable Mixture-of-Models router for heterogeneous LLM inference
...
> [!NOTE]- Online playground credentials
...
If you want to contribute, start with **[CONTRIBUTING.md](https://github.com/vllm-project/semantic-router/blob/main/CONTRIBUTING.md)**.

For repository-native development workflow and validation commands, use **[AGENTS.md](https://github.com/vllm-project/semantic-router/blob/main/AGENTS.md)** as the entrypoint and **[tools/agent/docs/README.md](https://github.com/vllm-project/semantic-router/blob/main/tools/agent/docs/README.md)** as the canonical index.
