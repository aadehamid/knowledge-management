...
# KV-Cache Aware Prompt Engineering - How Stable Prefixes Unlock 65% Latency Improvements

Exploring how KV-Cache aware prompt engineering can lead to significant latency improvements in LLMs.

Aug 18, 2025
•
[Ankit Sinha](https://twitter.com/ankitbko)
•
8 min read

[AI](/blog/categories/#AI)

[ML](/blog/categories/#ML)

[LLM](/blog/categories/#LLM)

[Large Language Model](/blog/categories/#Large Language Model)

[KV Cache](/blog/categories/#KV Cache)

[Prompt Engineering](/blog/categories/#Prompt Engineering)

[OpenAI](/blog/categories/#OpenAI)

Source Code

[![View On GitHub](/blog/assets/badges/github.svg)](https://github.com/ankitbko/prompt-engineering-kv-cache-exp)
...
![kv cache](/blog/assets/images/posts/kv-cache/kv-cache-explained.png)
...
I used the same dataset for both ([SCBench](https://huggingface.co/datasets/microsoft/SCBench) with repository QA, summarization, and few-shot examples), identical model settings (temperature=0.0, max\_tokens=1024), and ran 20 examples with 3 trials each. This gave me solid statistical power to measure the real impact of prompt stability on cache performance.

## The Results: A Complete Performance Transformation

![summary](/blog/assets/images/posts/kv-cache/summary.png)
...
![TTFT Comparison](/blog/assets/images/posts/kv-cache/ttft.png)
...
![Cache Effectiveness](/blog/assets/images/posts/kv-cache/cache-hit.png)
...
![Latency-Cache Relationship](/blog/assets/images/posts/kv-cache/latency-cache.png)
...
![Cost Analysis](/blog/assets/images/posts/kv-cache/cost-cache.png)
...
[« Patterns for Vision on the Edge - Part 2 - Handling Multiple Consumers](/blog/2022/06/vision-on-edge-part-2/)

[Microsoft Foundry Hosted Agents - What, Why, Protocols & Your First Deployment »](/blog/2026/05/hosted-agents-part-1/)
