title: GitHub - microsoft/LLMLingua: \[EMNLP'23, ACL'24\] To speed up LLMs' inference and enhance LLM's perceive of key information, compress the prompt and KV-Cache, which achieves up to 20x compression with minimal performance loss.
description: \[EMNLP&\#39;23, ACL&\#39;24\] To speed up LLMs&\#39; inference and enhance LLM&\#39;s perceive of key information, compress the prompt and KV-Cache, which achieves up to 20x compression with minimal per...
...
[![LLMLingua](https://github.com/microsoft/LLMLingua/raw/main/images/LLMLingua_logo.png){width=100}](https://github.com/microsoft/LLMLingua/blob/main/images/LLMLingua_logo.png)

 | [**Project Page**](https://llmlingua.com/) | [**LLMLingua**](https://aclanthology.org/2023.emnlp-main.825/) | [**LongLLMLingua**](https://aclanthology.org/2024.acl-long.91/) | [**LLMLingua-2**](https://aclanthology.org/2024.findings-acl.57/) | [**LLMLingua Demo**](https://huggingface.co/spaces/microsoft/LLMLingua) | [**LLMLingua-2 Demo**](https://huggingface.co/spaces/microsoft/LLMLingua-2) | 

> [!NOTE]+ LLMLingua_demo.mp4
> [\[Video\]](https://private-user-images.githubusercontent.com/30883354/273619158-eb0ea70d-6d4c-4aa7-8977-61f94bb87438.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..RQPcndk--VTi7A0EX04k5RsBFQudr0lDj_eXlSK39sU)
...
- 👨‍🦯 Explore our ['./examples'](https://github.com/microsoft/LLMLingua/blob/main/examples) directory for practical applications, including [LLMLingua-2](https://github.com/microsoft/LLMLingua/blob/main/examples/LLMLingua2.ipynb), [RAG](https://github.com/microsoft/LLMLingua/blob/main/examples/RAG.ipynb), [Online Meeting](https://github.com/microsoft/LLMLingua/blob/main/examples/OnlineMeeting.ipynb), [CoT](https://github.com/microsoft/LLMLingua/blob/main/examples/CoT.ipynb), [Code](https://github.com/microsoft/LLMLingua/blob/main/examples/Code.ipynb), and [RAG using LlamaIndex](https://github.com/microsoft/LLMLingua/blob/main/examples/RAGLlamaIndex.ipynb).
...
- [LongLLMLingua: Accelerating and Enhancing LLMs in Long Context Scenarios via Prompt Compression](https://aclanthology.org/2024.acl-long.91/) (ACL 2024 and ICLR ME-FoMo 2024)\
...
[![Background](https://github.com/microsoft/LLMLingua/raw/main/images/LLMLingua_motivation.png)](https://github.com/microsoft/LLMLingua/blob/main/images/LLMLingua_motivation.png)
...
[![Motivation for LLMLingua](https://github.com/microsoft/LLMLingua/raw/main/images/motivation.png)](https://github.com/microsoft/LLMLingua/blob/main/images/motivation.png)
...
[![Framework of LLMLingua](https://github.com/microsoft/LLMLingua/raw/main/images/LLMLingua.png)](https://github.com/microsoft/LLMLingua/blob/main/images/LLMLingua.png)

[![Framework of LongLLMLingua](https://github.com/microsoft/LLMLingua/raw/main/images/LongLLMLingua.png)](https://github.com/microsoft/LLMLingua/blob/main/images/LongLLMLingua.png)

[![Framework of LLMLingua-2](https://github.com/microsoft/LLMLingua/raw/main/images/LLMLingua-2.png)](https://github.com/microsoft/LLMLingua/blob/main/images/LLMLingua-2.png)
...
For more details about SecurityLingua, please refer to [securitylingua readme](https://github.com/microsoft/LLMLingua/blob/main/experiments/securitylingua/readme.md).
...
To understand how to apply LLMLingua and LongLLMLingua in real-world scenarios like RAG, Online Meetings, CoT, and Code, please refer to our [**examples**](https://github.com/microsoft/LLMLingua/blob/main/examples). For detailed guidance, the [**documentation**](https://github.com/microsoft/LLMLingua/blob/main/DOCUMENT.md) provides extensive recommendations on effectively utilizing LLMLingua.

To train the compressor on your custom data, please refer to our [**data\_collection**](https://github.com/microsoft/LLMLingua/blob/main/experiments/llmlingua2/data_collection) and [**model\_training**](https://github.com/microsoft/LLMLingua/blob/main/experiments/llmlingua2/model_training).

For more insights and answers, visit our [FAQ section](https://github.com/microsoft/LLMLingua/blob/main/Transparency_FAQ.md).
