...
[Inkling](/inkling/)[Tinker](/tinker/)[Connectionism](/blog/)[News](/news/)[Join us](/#join-us)

[Home](/)[Inkling](/inkling/)[Tinker](/tinker/)[Connectionism](/blog/)[News](/news/)[Join us](/#join-us)

# Defeating Nondeterminism in LLM Inference

[Horace He](https://x.com/cHHillee) in collaboration with others at Thinking Machines Sep 10, 2025

![](svgs/cover.svg)

* [The original sin: floating-point non-associativity](#the-original-sin-floating-point-non-associativity)
* [Why don’t kernels always add numbers in the same order?](#why-dont-kernels-always-add-numbers-in-the-same-order)
* [When are atomic adds needed?](#when-are-atomic-adds-needed)
  + [Batch invariance and “determinism”](#batch-invariance-and-determinism)
* [How do we make kernels batch-invariant?](#how-do-we-make-kernels-batch-invariant)
  + [Batch-invariant RMSNorm](#batch-invariant-rmsnorm)
  + [Batch-invariant matrix multiplication](#batch-invariant-matrix-multiplication)
  + [Batch-invariant attention](#batch-invariant-attention)
* [Implementation](#implementation)
* [Experiments](#experiments)
  + [How nondeterministic are completions?](#how-nondeterministic-are-completions)
  + [Performance](#performance)
  + [True on-policy RL](#true-on-policy-rl)
...
But what happens when we add two floating-point numbers with different exponents, such as 1230 and 23.4? In this case, the exact result is 1253.4. However, we can only maintain 3 digits of precision at a time. Floating-point addition will thus *drop* the last 2 digits and obtain the value 1.25∗1031.25 \* 10^31.25∗103 (or 1250).
...
back to top [next](/blog/modular-manifolds/ "Modular Manifolds")

#### Models

* [Inkling](/news/introducing-inkling/)
* [Inkling-Small](/news/inkling-small/)
* [Interaction](/blog/interaction-models/)
...
* [About](/blog/the-future-worth-building-is-human/)
* [Connectionism](/blog/)
* [News](/news/)
* [Careers](https://jobs.ashbyhq.com/ThinkingMachines)
...
* [X](https://x.com/thinkymachines)
* [LinkedIn](https://www.linkedin.com/company/thinkingmachinesai/)
* [YouTube](https://www.youtube.com/%40thinkymachines)
