title: Accelerating Generative AI with PyTorch II: GPT, Fast – PyTorch
...
![Screen recording](https://pytorch.org/assets/images/accelerating-generative-ai-2/screen-recording.gif)
...
## Starting Point (25.5 tok/s) {#starting-point-255-toks}

Let’s start off with an extremely basic and simple implementation.

![simple implementation](https://pytorch.org/wp-content/uploads/2024/11/image23.png){width=1678 height=1508}
...
![trace](https://pytorch.org/wp-content/uploads/2024/11/image14.png){width=1999 height=325}
...
![factory](https://pytorch.org/wp-content/uploads/2024/11/image16.png){width=1938 height=1748}
...
![factory](https://pytorch.org/wp-content/uploads/2024/11/image3.png){width=1934 height=1762}
...
## Step 1: Reducing CPU overhead through torch.compile and a static kv-cache (107.0 tok/s) {#step-1-reducing-cpu-overhead-through-torchcompile-and-a-static-kv-cache-1070-toks}
...
![code](https://pytorch.org/wp-content/uploads/2024/11/image2.png){width=1944 height=128}
...
![compile](https://pytorch.org/wp-content/uploads/2024/11/image9.png){width=1944 height=126}
...
![chart](https://pytorch.org/wp-content/uploads/2024/11/image28.png){width=1678 height=1502}
...
## Sidenote: How is torch.compile helping? {#sidenote-how-is-torchcompile-helping}
...
![code](https://pytorch.org/wp-content/uploads/2024/11/image24.png){width=724 height=86}

![code](https://pytorch.org/wp-content/uploads/2024/11/image17.png){width=1176 height=894}

## Step 2: Alleviating memory bandwidth bottleneck through int8 weight-only quantization (157.4 tok/s) {#step-2-alleviating-memory-bandwidth-bottleneck-through-int8-weight-only-quantization-1574-toks}
...
![weights](https://pytorch.org/wp-content/uploads/2024/11/image11.png){width=1304 height=1530}
...
![MBU](https://pytorch.org/wp-content/uploads/2024/11/image8.png){width=1999 height=372}
...
![MBU](https://pytorch.org/wp-content/uploads/2024/11/image25.png){width=1999 height=418}
...
![MBU](https://pytorch.org/wp-content/uploads/2024/11/image18.png){width=1438 height=330}
...
![MBU](https://pytorch.org/wp-content/uploads/2024/11/image7.png){width=1999 height=603}
...
![code](https://pytorch.org/wp-content/uploads/2024/11/image1.png){width=1014 height=286}

![code](https://pytorch.org/wp-content/uploads/2024/11/image27.png){width=1190 height=916}
...
![chart](https://pytorch.org/wp-content/uploads/2024/11/image19.png){width=1676 height=1514}

## Step 3: Reframing the problem using speculative decoding {#step-3-reframing-the-problem-using-speculative-decoding}
...
![diagram](https://pytorch.org/wp-content/uploads/2024/11/image5.png){width=1999 height=415}
...
![engineers](https://pytorch.org/wp-content/uploads/2024/11/image21.png){width=1999 height=1251}
...
![engineers](https://pytorch.org/wp-content/uploads/2024/11/image6.png){width=1999 height=1064}
...
![engineers](https://pytorch.org/wp-content/uploads/2024/11/image15.png){width=1999 height=1072}
...
![code](https://pytorch.org/wp-content/uploads/2024/11/image10.png){width=1999 height=811}
...
## Sidenote: Running this on AMD {#sidenote-running-this-on-amd}
...
![chart](https://pytorch.org/wp-content/uploads/2024/11/image4.png){width=1666 height=1160}

## Step 4: Reducing the size of the weights even more with int4 quantization and GPTQ (202.1 tok/s) {#step-4-reducing-the-size-of-the-weights-even-more-with-int4-quantization-and-gptq-2021-toks}
...
![table](https://pytorch.org/wp-content/uploads/2024/11/image13.png){width=1354 height=414}
...
![chart](https://pytorch.org/wp-content/uploads/2024/11/image12.png){width=1676 height=1508}

## Step 5: Combining everything together (244.7 tok/s) {#step-5-combining-everything-together-2447-toks}

Finally, we can compose all of the techniques together to achieve even better performance!

![chart](https://pytorch.org/wp-content/uploads/2024/11/image22.png){width=1999 height=1802}

## Step 6: Using Tensor Parallelism {#step-6-using-tensor-parallelism}
...
![code](https://pytorch.org/wp-content/uploads/2024/11/image20.png){width=1999 height=259}
...
![chart](https://pytorch.org/wp-content/uploads/2024/11/image26.png){width=1700 height=1150}
