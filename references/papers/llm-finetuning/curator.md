title: GitHub - bespokelabsai/curator: Synthetic data curation for post-training and structured data extraction
description: Synthetic data curation for post-training and structured data extraction - bespokelabsai/curator

# GitHub - bespokelabsai/curator: Synthetic data curation for post-training and structured data extraction

 [   ![Bespoke Labs Logo](https://github.com/bespokelabsai/curator/raw/main/docs/Bespoke-Labs-Logomark-Red-crop.png){width=100px}  ](https://bespokelabs.ai/) 

- **\[2026.06.09\]** [Fireworks AI integration for fine-tuning](https://github.com/bespokelabsai/curator/blob/main/examples/fireworks): Run managed supervised fine-tuning (SFT) on Fireworks AI with `FireworksTrainer` — upload curated data, train a LoRA, and sample from the deployed model behind the same trainer interface as Tinker.
- **\[2026.03.14\]** [Tinker integration for fine-tuning](https://github.com/bespokelabsai/curator/blob/main/examples/poem_finetuning_example.py): Go from curated data to a LoRA fine-tuned model in a few lines of Python using the Tinker SDK.
...
[![CLI in action](https://github.com/bespokelabsai/curator/raw/main/docs/curator-cli.gif)](https://github.com/bespokelabsai/curator/blob/main/docs/curator-cli.gif)
...
| **Task** | **Link(s)** | **Goal** |
|----|----|----|
| **Product feature extraction** | [![Open In Colab](https://camo.githubusercontent.com/eff96fda6b2e0fff8cdf2978f89d61aa434bb98c00453ae23dd0aab8d1451633/68747470733a2f2f636f6c61622e72657365617263682e676f6f676c652e636f6d2f6173736574732f636f6c61622d62616467652e737667)](https://colab.research.google.com/drive/1YoA23-cBcWpaSErULzBI2bo2LPGo37GQ) | Finetuning a model to identify features of a product |
| **Sentiment analysis** | [![Open In Colab](https://camo.githubusercontent.com/eff96fda6b2e0fff8cdf2978f89d61aa434bb98c00453ae23dd0aab8d1451633/68747470733a2f2f636f6c61622e72657365617263682e676f6f676c652e636f6d2f6173736574732f636f6c61622d62616467652e737667)](https://colab.research.google.com/drive/1Zfl3g7POsqqYQqkzXdyhYRSAymLhZugn?usp=sharing) | Aspect-based sentiment analysis of restaurant reviews and finetuning using Together.ai |
| **RAFT for domain-specific RAG** | [Code](https://github.com/bespokelabsai/curator/tree/main/examples/blocks/raft) | Implement Retrieval Augmented Fine-Tuning (RAFT) that processes domain-specific documents, generates questions, and prepares data for fine-tuning LLMs. |
| **Poem generation & LoRA fine-tuning** | [Code](https://github.com/bespokelabsai/curator/blob/main/examples/poem_finetuning_example.py) | End-to-end pipeline: curate poem data with Curator, then LoRA fine-tune with TinkerTrainer |
| **Managed fine-tuning on Fireworks AI** | [Code](https://github.com/bespokelabsai/curator/tree/main/examples/fireworks) | Run a managed SFT job on Fireworks AI with FireworksTrainer, then sample from the deployed LoRA model |
...
| **Multimodal** | [Code](https://github.com/bespokelabsai/curator/tree/main/examples/multimodal) | Demonstrates multimodal capabilities by generating recipes from food images |
| **Ungrounded Question Answer generation** | [Code](https://github.com/bespokelabsai/curator/tree/main/examples/ungrounded-qa) | Generate diverse question-answer pairs using techniques similar to the CAMEL paper |
| **Code Execution** | [![Open In Colab](https://camo.githubusercontent.com/eff96fda6b2e0fff8cdf2978f89d61aa434bb98c00453ae23dd0aab8d1451633/68747470733a2f2f636f6c61622e72657365617263682e676f6f676c652e636f6d2f6173736574732f636f6c61622d62616467652e737667)](https://colab.research.google.com/drive/1YKj1-BC66-3LgNkf1m5AEPswIYtpOU-k) | Execute code generated with Curator |
...
| **Synthetic charts** | [Code](https://github.com/bespokelabsai/curator/blob/main/examples/code-execution/chart-generation/charts.py) | Generate charts synthetically. |
| **Function calling** | [Code](https://github.com/bespokelabsai/curator/tree/main/examples/function-calling) | Generate data for finetuning for function calling. |
...
You can see more examples in the [examples](https://github.com/bespokelabsai/curator/blob/main/examples) directory.

See the [docs](https://docs.bespokelabs.ai/) for more details as well as for troubleshooting information.
...
See the full [poem fine-tuning example](https://github.com/bespokelabsai/curator/blob/main/examples/poem_finetuning_example.py) for an end-to-end pipeline that curates data with `curator.LLM` and then fine-tunes with `TinkerTrainer`.
...
> **Note:** Running real Fireworks training requires an account with training quota (Tier 2 / credits). Without the SDK or an API key, `FireworksTrainer` runs in mock mode so examples and tests work offline. Subclass `FireworksTrainer` and override `format_example()` to handle custom data layouts, exactly as with `TinkerTrainer`.

See the [Fireworks examples](https://github.com/bespokelabsai/curator/blob/main/examples/fireworks) for basic and custom-trainer pipelines.
...
Thank you to all the contributors for making this project possible! Please follow [these instructions](https://github.com/bespokelabsai/curator/blob/main/docs/CONTRIBUTING.md) on how to contribute.
