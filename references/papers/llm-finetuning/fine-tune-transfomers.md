...
description: Authored by: Edward Beeching, Quentin Gallouédec, and Lewis Tunstall Large reasoning models like OpenAI o3 generate a chain-of-thought to i
...
[\[Embedded Content\]](https://huggingface.co/datasets/HuggingFaceH4/Multilingual-Thinking/embed/viewer/default/train)
...
## Save the model and push to the Hugging Face Hub {#save-the-model-and-push-to-the-hugging-face-hub}
