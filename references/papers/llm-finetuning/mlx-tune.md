title: GitHub - ARahim3/mlx-tune: Fine-tune LLMs on your Mac with Apple Silicon. SFT, DPO, GRPO, Vision, TTS, STT, Embedding, and OCR fine-tuning — natively on MLX. Unsloth-compatible API.
description: Fine-tune LLMs on your Mac with Apple Silicon. SFT, DPO, GRPO, Vision, TTS, STT, Embedding, and OCR fine-tuning — natively on MLX. Unsloth-compatible API. - ARahim3/mlx-tune

# GitHub - ARahim3/mlx-tune: Fine-tune LLMs on your Mac with Apple Silicon. SFT, DPO, GRPO, Vision, TTS, STT, Embedding, and OCR fine-tuning — natively on MLX. Unsloth-compatible API.

 [![MLX-Tune Logo](https://raw.githubusercontent.com/ARahim3/mlx-tune/main/mlx-tune-logo.png){width=300}](https://raw.githubusercontent.com/ARahim3/mlx-tune/main/mlx-tune-logo.png) 
 ...
 *SFT, DPO, GRPO, Vision, TTS, STT, Embedding, and OCR fine-tuning — natively on MLX. Unsloth-compatible API.* 
 ...
 [![GitHub stars](https://camo.githubusercontent.com/ac8f17108dbeefdeab7379f6c0b3e33a3501274b27b129afa805b383fd659e0a/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f73746172732f61726168696d332f6d6c782d74756e653f7374796c653d736f6369616c)](https://github.com/ARahim3/mlx-tune) [![PyPI Downloads](https://camo.githubusercontent.)](https://pepy.tech/projects/mlx-tune) [![GitHub forks](https://camo.githubusercontent.com/471d9cf731af5c14518db8a98ee54e02727217acbc262e98d70d92d1491c51cf/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f666f726b732f61726168696d332f6d6c782d74756e65)](https://github.com/ARahim3/mlx-tune) \
 [![Platform](https://camo.githubusercontent.com/026d4fbd0e0f006489337874010e4185fa74643c33719f252c782efad22979ad/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f506c6174666f726d2d4170706c6525323053696c69636f6e2d626c61636b3f6c6f676f3d6170706c65)](#installation) [![Python](https://camo.githubusercontent.com/b305660672e6a0a20d5467ee1fe271badb1c03f17a10ebb447b1456e100f3d61/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f507974686f6e2d332e392b2d626c75653f6c6f676f3d707974686f6e266c6f676f436f6c6f723d7768697465)](#requirements) [![MLX](https://camo.githubusercontent.com/b74f5cf734c5f44e35819acae5ec26f9f857f9ceabfc87b5b8c4ead730eed665/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4d4c582d302e32302b2d677265656e)](https://github.com/ml-explore/mlx) [![License](https://camo.githubusercontent.com/3d153f9d5f084c8ce83883c0b7839305e3fb8abfe9672e13683ee511b902c6b5/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d417061636865253230322e302d6f72616e6765)](#license) 

 [Documentation](https://arahim3.github.io/mlx-tune/) · [Quick Start](#quick-start) · [Training Methods](#supported-training-methods) · [Examples](#examples) · [Status](#project-status) 
...
| **Continual Pretraining** | ✅ Stable | **CPTTrainer with decoupled LR, embed\_tokens/lm\_head, full-weight mode** |
...
> [!NOTE]
> **Merging into a 4-bit base**: the default `save_method="merged_16bit"` dequantizes the base before fusing, so the fine-tune is preserved exactly. `save_method="merged_4bit"` keeps the base quantized and re-quantizes the fused weights — smaller on disk, but a weak LoRA delta (low LR / few steps) can be rounded away. Prefer the 16-bit default, or keep the adapter and use `model.load_adapter(...)` at inference time.

> [!NOTE]
> **GGUF Export**: Works with non-quantized base models. If using a 4-bit model (like above), see [Known Limitations](#known-limitations) for workarounds.
...
See [`examples/38_gemma4_vision_finetuning.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/38_gemma4_vision_finetuning.py) for Gemma 4 vision fine-tuning, [`examples/39_gemma4_text_to_sql.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/39_gemma4_text_to_sql.py) for text-only fine-tuning through the VLM path, [`examples/10_qwen35_vision_finetuning.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/10_qwen35_vision_finetuning.py) for Qwen3.5, or [`examples/26_vision_grpo_training.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/26_vision_grpo_training.py) for Vision GRPO reasoning.
...
See [`examples/47_gemma4_audio_asr_finetuning.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/47_gemma4_audio_asr_finetuning.py) for ASR fine-tuning or [`examples/48_gemma4_audio_understanding.py`](https://github.com/ARahim3/mlx-tune/blob/main/examples/48_gemma4_audio_understanding.py) for audio understanding with audio tower LoRA.
...
See examples: [Orpheus](https://github.com/ARahim3/mlx-tune/blob/main/examples/12_orpheus_tts_finetuning.py), [OuteTTS](https://github.com/ARahim3/mlx-tune/blob/main/examples/14_outetts_finetuning.py), [Spark-TTS](https://github.com/ARahim3/mlx-tune/blob/main/examples/15_spark_tts_finetuning.py), [Qwen3-TTS](https://github.com/ARahim3/mlx-tune/blob/main/examples/20_qwen3_tts_finetuning.py).
...
See examples: [Whisper](https://github.com/ARahim3/mlx-tune/blob/main/examples/13_whisper_stt_finetuning.py), [Moonshine](https://github.com/ARahim3/mlx-tune/blob/main/examples/16_moonshine_stt_finetuning.py), [Qwen3-ASR](https://github.com/ARahim3/mlx-tune/blob/main/examples/17_qwen3_asr_finetuning.py), [Canary](https://github.com/ARahim3/mlx-tune/blob/main/examples/18_canary_stt_finetuning.py), [Voxtral](https://github.com/ARahim3/mlx-tune/blob/main/examples/19_voxtral_stt_finetuning.py), [Voxtral Realtime (streaming)](https://github.com/ARahim3/mlx-tune/blob/main/examples/49_voxtral_realtime_stt_finetuning.py), [Parakeet TDT English](https://github.com/ARahim3/mlx-tune/blob/main/examples/50_parakeet_english_finetuning.py), [Parakeet Welsh (new language)](https://github.com/ARahim3/mlx-tune/blob/main/examples/51_parakeet_welsh_finetuning.py), [Parakeet Bengali (auto vocab extension)](https://github.com/ARahim3/mlx-tune/blob/main/examples/52_parakeet_bengali_char_extension.py), [Parakeet Arabic (BPE extension)](https://github.com/ARahim3/mlx-tune/blob/main/examples/53_parakeet_arabic_bpe_fulltune.py).
...
See examples: [BERT](https://github.com/ARahim3/mlx-tune/blob/main/examples/27_embedding_finetuning.py), [Qwen3-Embedding](https://github.com/ARahim3/mlx-tune/blob/main/examples/28_qwen3_embedding_finetuning.py), [Harrier-0.6B](https://github.com/ARahim3/mlx-tune/blob/main/examples/31_harrier_0.6b_embedding_finetuning.py), [Harrier-270M](https://github.com/ARahim3/mlx-tune/blob/main/examples/32_harrier_270m_embedding_finetuning.py).
...
See examples: [Document OCR](https://github.com/ARahim3/mlx-tune/blob/main/examples/33_ocr_document_finetuning.py), [VLM→OCR](https://github.com/ARahim3/mlx-tune/blob/main/examples/34_qwen_vlm_ocr_finetuning.py), [Handwriting](https://github.com/ARahim3/mlx-tune/blob/main/examples/35_handwriting_ocr_finetuning.py), [OCR GRPO](https://github.com/ARahim3/mlx-tune/blob/main/examples/36_ocr_grpo_training.py), [Multilingual](https://github.com/ARahim3/mlx-tune/blob/main/examples/37_multilingual_ocr_finetuning.py).
...
See examples: [Language Adaptation](https://github.com/ARahim3/mlx-tune/blob/main/examples/43_cpt_language_adaptation.py), [Domain Knowledge](https://github.com/ARahim3/mlx-tune/blob/main/examples/44_cpt_domain_knowledge.py), [Code Capabilities](https://github.com/ARahim3/mlx-tune/blob/main/examples/45_cpt_code_capabilities.py), [LFM2 \+ CPT](https://github.com/ARahim3/mlx-tune/blob/main/examples/46_lfm2_cpt_domain.py).
...
See examples: [LFM2 SFT](https://github.com/ARahim3/mlx-tune/blob/main/examples/41_lfm2_sft_finetuning.py), [LFM2.5-Thinking](https://github.com/ARahim3/mlx-tune/blob/main/examples/42_lfm2_thinking_finetuning.py).
...
See examples: [Qwen3.5 MoE](https://github.com/ARahim3/mlx-tune/blob/main/examples/29_qwen35_moe_finetuning.py), [Phi-3.5 MoE](https://github.com/ARahim3/mlx-tune/blob/main/examples/30_phi35_moe_finetuning.py), [Trinity-Nano SFT](https://github.com/ARahim3/mlx-tune/blob/main/examples/54_trinity_moe_sft.py), [Trinity-Nano GRPO](https://github.com/ARahim3/mlx-tune/blob/main/examples/55_trinity_moe_grpo.py), [Trinity-Nano CPT](https://github.com/ARahim3/mlx-tune/blob/main/examples/56_trinity_moe_cpt.py).
...
Check [`examples/`](https://github.com/ARahim3/mlx-tune/blob/main/examples) for working code:
...
- Batched audio training (currently batch\_size\=1)
- Batched RL training (currently single-sample)

Apache 2.0 - See [LICENSE](https://github.com/ARahim3/mlx-tune/blob/main/LICENSE) file.
