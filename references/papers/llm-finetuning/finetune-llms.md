title: Finetune LLMs on your own consumer hardware using tools from PyTorch and Hugging Face ecosystem – PyTorch
...
## What makes our Llama fine-tuning expensive? {#what-makes-our-llama-fine-tuning-expensive}
...
## Parameter Efficient Fine-Tuning (PEFT) methods {#parameter-efficient-fine-tuning-peft-methods}
...
![Venn diagram](https://pytorch.org/wp-content/uploads/2024/11/fg1-10.png){width=1400 height=727}

*Image taken from the paper: [Scaling Down to Scale Up: A Guide to Parameter-Efficient Fine-Tuning](https://arxiv.org/pdf/2303.15647.pdf)*
...
## Low-Rank Adaptation for Large Language Models (LoRA) using 🤗 PEFT {#low-rank-adaptation-for-large-language-models-lora-using--peft}

[The LoRA method](https://arxiv.org/pdf/2106.09685.pdf) by Hu et al. from the Microsoft team came out in 2021, and works by attaching extra trainable parameters into a model(that we will denote by *base model*).
...
![Animated diagram that show how LoRA works in practice](https://pytorch.org/wp-content/uploads/2024/11/fg2.gif){width=600 height=439}

*Animated diagram that show how LoRA works in practice – original content adapter from the figure 1 of LoRA [original paper](https://arxiv.org/abs/2106.09685)*

Below is a code snippet showing how to train LoRA model using Hugging Face PEFT library:

![code snippet showing how to train LoRA model using  Hugging Face PEFT library](https://pytorch.org/wp-content/uploads/2024/11/fg3-9.png){width=1600 height=953}

## The base model can be in any `dtype`: leveraging SOTA LLM quantization and loading the base model in 4-bit precision {#the-base-model-can-be-in-any-dtype-leveraging-sota-llm-quantization-and-loading-the-base-model-in-4-bit-precision}
...
## QLoRA: One of the core contributions of `bitsandbytes` towards the democratization of AI {#qlora-one-of-the-core-contributions-of-bitsandbytes-towards-the-democratization-of-ai}
...
![System diagram](https://pytorch.org/wp-content/uploads/2024/11/fg4-4.png){width=1155 height=467}
...
## Using QLoRA in practice {#using-qlora-in-practice}
...
You can read more about quantization features in this specific section of the documentation: [https://huggingface.co/docs/transformers/main\_classes/quantization](https://huggingface.co/docs/transformers/main_classes/quantization)
...
![code snippet showing how to train QLoRA model using Hugging Face PEFT](https://pytorch.org/wp-content/uploads/2024/11/fg5-6.png){width=1600 height=1281}

## Using TRL for LLM training {#using-trl-for-llm-training}
...
![Process diagram](https://pytorch.org/wp-content/uploads/2024/11/fg6-6.png){width=1600 height=999}
...
![Sample diagram](https://pytorch.org/wp-content/uploads/2024/11/fg7-5.png){width=1486 height=690}
...
![Memory usage diagram](https://pytorch.org/wp-content/uploads/2024/11/fg8-4.png){width=525 height=235}
